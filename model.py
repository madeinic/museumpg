...
class BaseModel:
    def __init__(self, app, vao_name, tex_id, pos =(0,0,0), rot=(0, 0, 0), scale = (1, 1, 1)):
        ...
        self.tex_id = tex_id
        #obtener la vao necesaria atraves de mesh
    ...
    def get_model_matrix(self):
        ...
        #rotar para cada uno de los ejes
...
class Mono(ExtendedBaseModel):
    def __init__(self, app, vao_name='mono', tex_id='mono', 
...
class Gato(ExtendedBaseModel):
    def __init__(self, app, vao_name='gato', tex_id='gato', 
                 pos = (0, 0, 0), rot=(-90, 0, 0), scale = (0.025, 0.025, 0.025)):
        super().__init__(app, vao_name, tex_id, pos, rot, scale)
        self.on_init()
...
class Perro(ExtendedBaseModel):
    def __init__(self, app, vao_name='perro', tex_id='perro', 
